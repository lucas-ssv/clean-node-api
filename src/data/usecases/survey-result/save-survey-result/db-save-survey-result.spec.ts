...
import { mockFakeSaveSurveyResultParams, mockFakeSurveyResultModel } from '@/data/test/mock-fake-survey-result'
...
describe('DbSaveSurveyResult Usecase', () => {
  ...
  test('Should call DbSaveSurveyResult with correct values', async () => {
    ...
    const surveyResultData = mockFakeSaveSurveyResultParams()
  ...
  test('Should throw if SaveSurveyResultRepository throws', async () => {
    ...
    const promise = sut.save(mockFakeSaveSurveyResultParams())
    await expect(promise).rejects.toThrow()
  })

  test('Should return SurveyResult on success', async () => {
    const { sut } = makeSut()
    const surveyResult = await sut.save(mockFakeSaveSurveyResultParams())
